...
## 0.47.2
* another "pre-release" version of Nix Debug (for testing the pre-release feature)

## 0.47.1
* first "pre-release" version of Nix Debug: pre-release versions use odd minor version numbers
* use a pre-release version of the DAP modules

## 0.46.11
* preparing to publish "pre-release" version of Nix Debug
...
## 0.46.1
* Improved overall stepping behavior: nix debug now behaves like a real debugger: it breaks on a line before executing the line. Previously it was breaking while executing the line.
...
## 0.45.8
* Register Nix Debug as default debugger for markdown files
...
* Support to run Nix Debug in the browser/web worker
...
## 0.22.0
* Refactored the 'Nix Debugger' functionality into a separate class. This makes it more obvious how a debug adapter 'adapts' to a debugger or runtime.
